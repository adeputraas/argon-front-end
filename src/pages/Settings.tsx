...
const Settings = () => {
  ...
  const retrieveGetUserDetail = async () => {
    const respRetrieveUser = await API.get(
      'USERS',
      `retrieve-detail-user/${userDetail.idUser}`,
    );
    if (respRetrieveUser.status === 'Bad Request') {
      ...
      setUserName(objAssign.username);
      setEmailUser(objAssign.email);
      setPhoneNumber(respRetrieveUser.data[0].phoneNumber);
      setUserName(objAssign.username);
      setPosition(objAssign.role);
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              <div className="p-7">
                <form action="#">
                  <div className="p-7">
                    <form action="#">
                      <div className="mb-4 flex items-center gap-3" style={{placeContent: 'center'}}>
                        <div className="h-14 w-14 rounded-full">
                          <img
                            src={
                              userDetail.photo
                                ? `http://localhost:3030/uploads/${userDetail.photo}`
                                : userThree
                            }
                            alt="User"
                          />
